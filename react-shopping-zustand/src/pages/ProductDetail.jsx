    ...
    <div className="border border-black p-10">
      <div className="grid grid-cols-1  md:grid-cols-2 gap-5">
        <div className="col-span-1">
          <img src={currentProduct.image} alt=""  className='md:w-3/4 md:h-auto block mb-5 md:mb-0 md:mx-auto h-[200px]' />
        </div>
        ...
        <div className="flex justify-between items-end w-full mt-auto">
          ...
          {carts.find((cart)=>(cart.productId == currentProduct.id)) ? <button  className='text-sm border border-black px-3 py-2 bg-black text-white' >Added</button> : <button className='text-sm border border-black px-3 py-2' onClick={handleAddCart} >Add cart</button>}
          </div>
        </div>
