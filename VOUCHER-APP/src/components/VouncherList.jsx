...
import { HiComputerDesktop, HiTrash } from 'react-icons/hi2'
import { Link } from 'react-router-dom'

const VouncherList = () => {
  return (
    <div>
          <h1 className='text-3xl font-bold mb-5'>Voucher List</h1>
  ...
  <div className="">
  <Link to="/sale"  className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Create Sale
    <HiComputerDesktop className="inline-block ms-2" />
  </Link>
